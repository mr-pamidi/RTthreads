...
pthread_cond_t cond_capture_thread = PTHREAD_COND_INITIALIZER;
...
{
    int rc;
    pthread_t thread1, thread2, thread3, capture_thread;
    pthread_attr_t thread1_attr, thread2_attr, thread3_attr, capture_thread_attr;
    threadParams_t thread1Idx, thread2Idx, thread3Idx, capture_threadIdx;
    struct sched_param thread1_sched_param, thread2_sched_param, thread3_sched_param, capture_thread_sched_param;
    ...
    assign_RT_schedular_attr(&capture_thread_attr, &capture_thread_sched_param, SCHED_FIFO, CAPTURE_THREAD_PRIORITY, (jetson_tx2_cores)JETSON_TX2_ARM_CORE2);
